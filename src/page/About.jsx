    ...
    <div className="mt-20 md:mt-32">
      <Container>
        <div className="flex flex-col md:flex-row justify-between items-center p-6 md:p-16 bg-white shadow-lg rounded-lg gap-8">
          {/* Profile / Image Box */}
          <div className="relative w-full md:w-[420px] h-[460px] bg-red-300 rounded-lg flex-shrink-0">
            <div className="w-full md:w-[275px] p-4 bg-white absolute left-1/2 bottom-[-30px] transform -translate-x-1/2 rounded-lg shadow-lg">
              <ul className="flex justify-between items-center">
                {[IoEarth, FaFacebookF, FaInstagram, GrLinkedinOption, FaBehance].map(
                  (Icon, idx) => (
                    <li
                      key={idx}
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              ...
              <a href="/Md Jihadul Islam.pdf" download="Md_Jihadul_Islam_CV.pdf">
